      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-border shadow-lg">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>Start automating your payment reminders today</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2 bg-accent/5 rounded-lg p-3">
              <div className="flex items-start gap-2">
                ...
                <span className="text-sm text-foreground">AI-generated email sequences</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-accent mt-0.5 flex-shrink-0" />
                <span className="text-sm text-foreground">Automatic scheduling & sending</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-accent mt-0.5 flex-shrink-0" />
                <span className="text-sm text-foreground">Free trial included</span>
              </div>
            </div>
